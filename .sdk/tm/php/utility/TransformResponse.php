...
// Contentful SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ContentfulTransformResponse
{
    public static function call(ContentfulContext $ctx): mixed
    {
        ...
        $transform = ContentfulHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
