...
// Contentful SDK utility: fetcher
...
class ContentfulFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ContentfulSDK/1.0)';
    ...
    public static function call(ContentfulContext $ctx, string $fullurl, array $fetchdef): array
    {
