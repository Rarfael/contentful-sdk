...
{
    private static function utility(): ContentfulUtility
    {
        return new ContentfulUtility();
    }
    ...
    private static function ctx(array $over = []): ContentfulContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ContentfulContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ContentfulOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ContentfulError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ContentfulOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ContentfulMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ContentfulOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ContentfulMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ContentfulOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ContentfulMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ContentfulSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ContentfulMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ContentfulResponse([]),
            'result' => new ContentfulResult([]),
        ]);
        [, $err] = ContentfulMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ContentfulSpec([]),
            'response' => null,
            'result' => new ContentfulResult([]),
        ]);
        [, $err] = ContentfulMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ContentfulSpec(['step' => 's']),
            'response' => new ContentfulResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ContentfulResult([]),
        ]);
        [, $err] = ContentfulMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ContentfulSpec(['step' => 's']),
            'response' => new ContentfulResponse(self::resp(200, ['v' => 1])),
            'result' => new ContentfulResult([]),
        ]);
        [, $err] = ContentfulMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ContentfulSpec(['step' => 's']),
            'response' => new ContentfulResponse(self::resp(200, ['v' => 2])),
            'result' => new ContentfulResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ContentfulMakeResponse::call($ctx);
    ...
    {
        $preset = new ContentfulResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ContentfulSpec([]),
            'response' => new ContentfulResponse([]),
            'result' => new ContentfulResult([]),
        ...
        [$got, $err] = ContentfulMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ContentfulResult([])]);
        [, $err] = ContentfulMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ContentfulSpec([]), 'result' => null]);
        [, $err] = ContentfulMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ContentfulSpec(['step' => 's']),
            'result' => new ContentfulResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ContentfulOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ContentfulMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ContentfulSpec(['step' => 's']),
            'result' => new ContentfulResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ContentfulOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ContentfulMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ContentfulResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ContentfulSpec([]),
            'result' => new ContentfulResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ContentfulMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ContentfulMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ContentfulError('boom', 'boom');
        $utility->fetcher = function (ContentfulContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ContentfulSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ContentfulMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ContentfulContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ContentfulMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ContentfulResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ContentfulMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ContentfulContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ContentfulSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ContentfulMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ContentfulResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ContentfulSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ContentfulMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ContentfulMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ContentfulMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ContentfulResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ContentfulDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ContentfulResult(['ok' => false])]);
        $this->expectException(ContentfulError::class);
        ContentfulDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ContentfulResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ContentfulMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ContentfulMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ContentfulBaseFeature();
        $b = new ContentfulBaseFeature();
        ContentfulFeatureAdd::call($ctx, $a);
        ContentfulFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ContentfulBaseFeature
    {
        $f = new ContentfulBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ContentfulFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ContentfulContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ContentfulSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ContentfulPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ContentfulPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ContentfulResponse(['headers' => null]),
            'result' => new ContentfulResult([]),
        ]);
        ContentfulResultHeaders::call($ctx);
