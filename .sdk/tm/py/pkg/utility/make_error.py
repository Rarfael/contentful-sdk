# Contentful SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ContentfulError):
        errmsg = err.msg
    ...
    msg = "ContentfulSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ContentfulError("", msg, ctx)
