# Contentful SDK primary utility test
...
from projectname_sdk import ContentfulSDK
from projectname_sdk.core.spec import ContentfulSpec
from projectname_sdk.core.result import ContentfulResult
from projectname_sdk.core.response import ContentfulResponse
from projectname_sdk.core.operation import ContentfulOperation
from projectname_sdk.core.error import ContentfulError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ContentfulBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ContentfulError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ContentfulSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ContentfulSDK.test(None, None)
        ...
        class TestInitFeature(ContentfulBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ContentfulBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ContentfulSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ContentfulSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ContentfulSDK.test(None, setup_opts)
