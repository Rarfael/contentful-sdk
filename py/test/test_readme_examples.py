# Contentful SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ContentfulSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ContentfulSDK(...) and ContentfulSDK.test(...) become
#      ContentfulSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "contentful_sdk"
_SDK_CLASS = "ContentfulSDK"
