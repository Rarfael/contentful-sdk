...
from contentful_sdk.core.control import ContentfulControl
...
from contentful_sdk.core.helpers import get_ctx_prop, to_map
...
class ContentfulContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ContentfulSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ContentfulResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ContentfulResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ContentfulError(code, msg, self)
