...
from contentful_sdk.utility import register

# Load features
from contentful_sdk.feature.base_feature import ContentfulBaseFeature
from contentful_sdk.features import _has_feature, _make_feature
...
class ContentfulSDK:
    ...
    def get_utility(self):
        return ContentfulUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ContentfulSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entry(self, data=None) -> "EntryEntity":
        ...
        from contentful_sdk.entity.entry_entity import EntryEntity
        return EntryEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ContentfulSDK":
        if sdkopts is None:
            sdkopts = {}
