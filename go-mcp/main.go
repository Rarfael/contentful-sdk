// Command Contentful-mcp is an MCP server exposing the Contentful
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Contentful_list  — list records of an entity
//	Contentful_load  — load a single record of an entity
//
