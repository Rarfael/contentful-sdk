...
(0, node_test_1.describe)('EntryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ContentfulSDK({
    ...
    (0, node_test_1.test)('direct-load-entry', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["environment01", "space01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-entry', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-entry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["environment01", "space01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        const client = new __1.ContentfulSDK({
...
//# sourceMappingURL=EntryDirect.test.js.map