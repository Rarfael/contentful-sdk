...
function envOverride(m) {
    if ('TRUE' === process.env.CONTENTFUL_TEST_LIVE ||
        'TRUE' === process.env.CONTENTFUL_TEST_OVERRIDE) {
    ...
    m.CONTENTFUL_TEST_EXPLAIN = process.env.CONTENTFUL_TEST_EXPLAIN || m.CONTENTFUL_TEST_EXPLAIN;
    return m;
}
