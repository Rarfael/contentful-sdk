...
exports.ContentfulEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends ContentfulEntityBase<Advice>`.
class ContentfulEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.ContentfulEntityBase = ContentfulEntityBase;
//# sourceMappingURL=ContentfulEntityBase.js.map