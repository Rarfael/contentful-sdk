...
class EntryEntity extends ContentfulEntityBase<Entry> {
  ...
  make(this: EntryEntity) {
    return new EntryEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: EntryLoadMatch, ctrl?: Control): Promise<EntryEntity> {
  ...
  async create(this: any, reqdata?: EntryCreateData, ctrl?: Control): Promise<EntryEntity> {
  ...
  async update(this: any, reqdata?: EntryUpdateData, ctrl?: Control): Promise<EntryEntity> {
  ...
  async remove(
    this: any, reqmatch?: EntryRemoveMatch, ctrl?: Control,
  ): Promise<EntryEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<EntryEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
