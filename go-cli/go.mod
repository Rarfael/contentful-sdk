module github.com/voxgig-sdk/contentful-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/contentful-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/contentful-sdk/go => ../go
