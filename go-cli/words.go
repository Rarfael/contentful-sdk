...
func registerSDKWords(r *eng.Registry, client *sdk.ContentfulSDK) {
...
func runOp(client *sdk.ContentfulSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
