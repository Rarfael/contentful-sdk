...
// Contentful SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ContentfulSDK::test)
...
{
    private const SDK_CLASS = 'ContentfulSDK';
    ...
    private const SDK_BASE = 'contentful_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../contentful_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
