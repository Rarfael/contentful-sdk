...
class ContentfulTestRunner
{
    ...
    {
        $live = self::getenv('CONTENTFUL_TEST_LIVE');
        $override = self::getenv('CONTENTFUL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CONTENTFUL_TEST_EXPLAIN');
...
class_alias('ContentfulTestRunner', 'Runner');
class_alias('ContentfulHelpers', 'Helpers');
