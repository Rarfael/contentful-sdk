...
// Contentful SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ContentfulMakeRequest
{
    public static function call(ContentfulContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ContentfulResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ContentfulResponse($fetched);
        } else {
