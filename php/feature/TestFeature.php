...
// Contentful SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ContentfulTestFeature extends ContentfulBaseFeature
{
    ...
    public function init(ContentfulContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ContentfulContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ContentfulParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ContentfulContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ContentfulContext $ctx, $op, $args): array
    {
