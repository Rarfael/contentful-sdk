...
func NewEntryEntity(client *core.ContentfulSDK, entopts map[string]any) *EntryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EntryEntity) GetName() string { return e.name }
...
func (e *EntryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EntryEntity) Deleted() bool {
	return e.deleted
}


func (e *EntryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntryEntity(e.client, opts)
}

func (e *EntryEntity) Data(args ...any) any {
...
func (e *EntryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Entry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) DataTyped(data ...Entry) Entry {
	if len(data) > 0 {
		return typedFrom[Entry](e.Data(asMap(data[0])))
	}
	return typedFrom[Entry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Entry (all fields
// optional at the wire level).
func (e *EntryEntity) MatchTyped(match ...Entry) Entry {
	if len(match) > 0 {
		return typedFrom[Entry](e.Match(asMap(match[0])))
	}
	return typedFrom[Entry](e.Match())
}
...
func (e *EntryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EntryLoadMatch and returns an Entry. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) LoadTyped(reqmatch EntryLoadMatch, ctrl map[string]any) (Entry, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Entry{}, err
	}
	return typedFrom[Entry](res), nil
}




func (e *EntryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EntryListMatch and returns []Entry. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) ListTyped(reqmatch EntryListMatch, ctrl map[string]any) ([]Entry, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Entry](res), nil
}




func (e *EntryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EntryCreateData and returns an Entry. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) CreateTyped(reqdata EntryCreateData, ctrl map[string]any) (Entry, error) {
...
func (e *EntryEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EntryUpdateData and returns an Entry. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) UpdateTyped(reqdata EntryUpdateData, ctrl map[string]any) (Entry, error) {
...
func (e *EntryEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EntryRemoveMatch and returns an Entry. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EntryEntity) RemoveTyped(reqmatch EntryRemoveMatch, ctrl map[string]any) (Entry, error) {
...
func (e *EntryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
